...
class ChromaDBStore(VectorStore):
    ...
    def __init__(self, collection_name: str = "documents", persist_directory: str = "./chroma_store"):
    ...
    def load_documents_from_directory(self, directory_path: str, file_pattern: str = "*.txt") -> None:
